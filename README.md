...
Creates static pedestrians near the ego vehicle. The script tries navigation points first. If there are not enough points, it uses fallback positions around the vehicle.
